...
```sh
curl -fsSL https://raw.githubusercontent.com/LAGcomcom/frp-panel/main/install.sh | sudo sh
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/LAGcomcom/frp-panel/main/install.sh | \
...
```sh
curl -fsSL https://raw.githubusercontent.com/LAGcomcom/frp-panel/main/install.sh | sudo sh -s -- --update
```
